...
export default function SingleSessionEquitiesLaunch() {
  return (
    <>
      <p className="lead">
        On May 1, 2026, Hybrid Funding added Single Session Equities to the product lineup and expanded its platform coverage around equity trading.
      </p>
      <h2>A dedicated path for stock traders</h2>
      <p>
