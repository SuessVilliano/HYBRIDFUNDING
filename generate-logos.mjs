...
await convertSvgToImages('./client/src/assets/hybrid-funding-logo.svg', 'hybrid-funding-logo');

// Process the icon logo
await convertSvgToImages('./client/src/assets/hybrid-funding-logo-icon.svg', 'hybrid-funding-logo-icon');
